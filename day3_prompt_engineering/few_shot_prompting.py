...
Extract information and respond ONLY with valid JSON matching this schema, no other text, no markdown fences.
Look at examples below and provide the output in the same format. If any field is missing, return an empty string or empty array as appropriate:
{
  "role_title": "string",
...
Input: "Looking for a part-time bookkeeper, $25/hr, must know QuickBooks. 3-month contract."
Output: {"role_title": "Bookkeeper", "compensation_type": "hourly", "required_skills": ["QuickBooks"], "is_long_term": false}

Input: "Seeking a long-term backend engineer to join our core team. Salary based, Python and PostgreSQL required."
Output: {"role_title": "Backend Engineer", "compensation_type": "salary", "required_skills": ["Python", "PostgreSQL"], "is_long_term": true}
"""
...
print(raw_output)
print(parsed["compensation_type"])
print(parsed["is_long_term"])
